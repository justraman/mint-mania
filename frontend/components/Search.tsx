      ...
      <div className="mb-10 items-center flex flex-col gap-2">
        ...
        <form onSubmit={onSearch} >
          <div className="flex w-full mt-3 max-w-sm items-center space-x-2">
            <Input className="text-green-900 text-xl rounded-none" type="text" value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search..." />
            <Button type="submit" className="text-green-900 text-xl rounded-none hover:bg-black hover:text-primary">
